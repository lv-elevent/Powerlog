...
import { BookOpen, Check, Droplets, Flame, Goal, Moon, Sparkles, Star, Wallet, Dumbbell } from "lucide-react";
...
export default function ReviewPage() {
  ...
  if (done) return <main className="flex min-h-[75vh] flex-col items-center justify-center text-center"><div className="flex h-24 w-24 items-center justify-center rounded-[30px] bg-blue-50 text-blue-600"><Sparkles size={46} /></div><h1 className="sr-only">今天完成得很好</h1><div className="eyebrow mt-6">今天完成得很好</div><p className="mt-2 text-slate-500">真实复盘已保存，今日已关闭。</p><Link href="/today" className="primary-button mt-8 px-10">回到首页</Link></main>;
